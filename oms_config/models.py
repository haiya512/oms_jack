...
class Zone(models.Model):
    departments = models.ForeignKey(Department, on_delete=models.CASCADE, verbose_name=u'业务组')
...
class Upload(models.Model):
    departments = models.ForeignKey(Department, verbose_name=u'业务组', on_delete=models.CASCADE)
